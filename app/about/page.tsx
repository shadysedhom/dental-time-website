...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col absolute top-0 left-0 w-full items-center justify-center gap-2 bg-slate-50 bg-cover" style={{ backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.6)), url('${bgImageUrl}')` }}>
      ...
      <div className="text-center pt-10 px-20">
        ...
        <h2 className="text-2xl mt-4 font-semibold text-slate-800">
          Uw Mondgezondheid Is In
          Goede Handen Bij Ons
        </h2>
      </div>
