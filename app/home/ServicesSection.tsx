...
export default function ServicesSection() {
    ...
    const services = [
        {
            Icon: () => (
                <svg className={iconClassName} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M11 4.17632C11.2214 3.99352 11.4514 3.78582 11.689 3.55032C13.9947 1.2656 17.1348 1.71292 18.606 3.55032L18.6199 3.56767C19.2499 4.35428 20.4545 5.85823 19.8213 9.5M11 4.17632C12.4967 5.41228 13.5 5.5 14 5M11 4.17632C10.7786 3.99352 10.5486 3.78582 10.311 3.55032C8.0053 1.2656 4.86519 1.71292 3.39399 3.55032C2.37784 4.8194 -0.222479 7.97857 6.14215 19.2396C6.40566 19.7058 6.9306 20 7.49601 20C8.39799 20 9.10296 19.2801 9.13229 18.4399C9.17779 17.1365 9.42981 15.6853 10.1334 15" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"></path>
                    <path d="M15.7227 16.7216L17.0003 18L19 15.5" stroke="currentColor" strokeWidth="1.5"></path>
                    <path d="M22 13.8C22 18.2998 21.2898 20.65 17.5 22C13.7102 20.65 13 18.2998 13 13.8L17.5 12L22 13.8Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"></path>
                </svg>
            ),
        ...
        {
            Icon: () => (
                <svg className={iconClassName} fill="currentColor" height="24" width="24" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 511.998 511.998"  stroke="#000000" strokeWidth="7.67997"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <g>
                    ...
                    <path stroke="currentColor"  d="M435.855,136.679c-7.368,0-13.342,5.972-13.342,13.342c0,22.275-9.158,85.64-29.516,156.764 c-2.028,7.082,2.071,14.47,9.154,16.496c7.053,2.028,14.464-2.049,16.497-9.154c21.069-73.606,30.546-140.273,30.546-164.105 C449.197,142.652,443.223,136.679,435.855,136.679z"></path>
                    <path stroke="currentColor"  d="M150.388,62.434c-48.295,0-87.588,39.291-87.588,87.586c0,7.37,5.974,13.342,13.342,13.342s13.342-5.972,13.342-13.342 c0-33.582,27.32-60.902,60.904-60.902c7.368,0,13.342-5.972,13.342-13.342S157.756,62.434,150.388,62.434z"></path> </g> </g> </g> </g>
                </svg>
            ),
        ...
        {
            Icon: () => (
                <svg className={iconClassName} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" data-src="https://cdn.hugeicons.com/icons/relieved-01-stroke-standard.svg">
                    <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></circle>
                    <path d="M7 9C7.20949 9.5826 7.77476 10 8.43922 10C9.10367 10 9.66894 9.5826 9.87843 9M14.1216 9C14.3311 9.5826 14.8963 10 15.5608 10C16.2252 10 16.7905 9.5826 17 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
        ...
        {
            Icon: () => (
                <svg className={iconClassName} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"  fill="none" >
        ...
        },
        {
            ...
            description: "Effectieve behandelingen om pijn te verlichten en tanden te redden.",
        },
        {
            Icon: () => (
                <svg className={iconClassName} fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 403.647 403.647" ><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g>
                ...
                <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="flex flex-col gap-4 md:gap-8">
                        ...
                        <p className=" max-w-[700px] text-gray-600 md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed">
                            Wij bieden uitgebreide tandheelkundige zorg met een focus op comfort en duurzame resultaten. Ons ervaren team maakt gebruik van de nieuwste technologie om de best mogelijke behandeling te garanderen.
                        </p>
                    </div>
                </div>
