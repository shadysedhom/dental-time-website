            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid gap-10 lg:grid-cols-5">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        {/* Footer Logo */}
                        <img src="/dental-time-black.svg" alt="Logo" className="h-12 w-auto" />

                        {/* Mission statement */}
                        <p className="mt-4 max-w-xs text-gray-600 leading-loose">
                            Uw glimlach is onze zorg. Bij Dental Time bieden we aandachtige tandheelkundige zorg. Samen werken we aan een stralende, gezonde lach.
                        </p>
                    ...
                    {/* Openingtimes Column */}
                    <div>
                        <h3 className="text-lg font-semibold text-navy-900 uppercase">Openingstijden</h3>
                    ...
                    {/* Footer Menu Column */}
                    <div>
                        <h3 className="text-lg font-semibold text-navy-900 uppercase">Menu</h3>
                    ...
                    {/* Contact Column */}
                    <div>
                        <h3 className="text-lg font-semibold text-navy-900 uppercase">Contact</h3>
